...
const meals = [
  {
    ...
    items: [
      { name: 'Paratha', quantity: '1.0', calories: '289 Cal' },
      { name: 'Tea', quantity: '1.0', calories: '73 Cal' },
    ],
  },
  {
    ...
    calories: '73/215 Cal',
    items: [
      { name: 'Oats', quantity: '1.0', calories: '73 Cal' },
    ],
  },
      ...
      <ScrollView style={styles.scrollView}>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.dateScroller}>
          {days.map((item, index) => (
            <TouchableOpacity
              key={index}
              style={[styles.dateButton, item.active && styles.activeDateButton]}
            >
              <Text style={[styles.dateDay, item.active && styles.activeDateText]}>{item.day}</Text>
              <View style={styles.dateNumber}>
                <Text style={[styles.dateNumberText, item.active && styles.activeDateNumberText]}>{item.date}</Text>
              </View>
            </TouchableOpacity>
          ))}
        </ScrollView>
        ...
        <View style={styles.calorieCard}>
          <View style={styles.calorieCircle}>
            <Text style={styles.calorieNumber}>429</Text>
