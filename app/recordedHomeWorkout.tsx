      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.grid}>
          <View style={styles.gridItem}>
            <TouchableOpacity
              onPress={() => handlePress("/worktype/Gym Workout")}
            >
              <Image
          ...
          <View style={styles.gridItem}>
            <TouchableOpacity
              onPress={() => handlePress("/worktype/Cardio Workout")}
            >
              <Image
          ...
          <View style={styles.gridItem}>
            <TouchableOpacity onPress={() => handlePress("/worktype/CrossFit")}>
              <Image
          ...
          <View style={styles.gridItem}>
            <TouchableOpacity onPress={() => handlePress("/worktype/Zumba")}>
              <Image
          ...
          <View style={styles.gridItem}>
            <TouchableOpacity onPress={() => handlePress("/worktype/Aerobics")}>
              <Image
          ...
          <View style={styles.gridItem}>
            <TouchableOpacity onPress={() => handlePress("/worktype/Boxing")}>
              <Image
          ...
          <View style={styles.gridItem}>
            <TouchableOpacity onPress={() => handlePress("/worktype/MMA")}>
              <Image
          ...
          <View style={styles.gridItem}>
            <TouchableOpacity onPress={() => handlePress("/worktype/Yoga")}>
              <Image
